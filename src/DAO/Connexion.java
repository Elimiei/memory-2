...
/* penser à démarrer sql server et sql browser dans services */
/* sql server config manager : config réseau -> protocole -> démarrer tcp ip*/
...
public class Connexion {
    ...
    private static final String MDP = "not24get";
    private static final String NOM_SERVEUR = "DESKTOP-EJESPP0";
